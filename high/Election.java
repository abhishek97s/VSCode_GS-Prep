...
/**
     ...
     * class president.
     * The teacher does this by singing a song while walking around the circle.
     * After the song is
     ...
     * resumes singing and walking around the circle.
     * After the teacher is done singing, the next student is removed. The teacher
     * repeats this until only one student is left.
     *
     ...
     * students to start with (1,2,3,4). The first
     * student to go would be `2`, after that `4`, and after that `3`. Student `1`
...
// we can clearly see the following pattern:

// Jn,k=((Jn−1,k+k−1)modn)+1
// J1,k=1
// Here, 1-indexing makes for a somewhat messy formula; if you instead number
// the positions from 0, you get a very elegant formula:

// Jn,k=(Jn−1,k+k)modn
// So, we found a solution to the problem of Josephus, working in O(n)
// operations.